...
namespace System.Web.Mvc.Html
{
    ...
    public static class EnumHelper
    {
        ...
        public static string ToDescription(this Enum value)
        {
            ...
            return attributes.Length > 0 ? attributes[0].Description : string.Empty; //Convert.ToString(value);
        }
        ...
        public static MvcHtmlString EnumDropDownListFor<TModel, TEnum>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TEnum>> expression, object attributes = null)
        {
            ...
            IEnumerable<SelectListItem> items =
                values.Where(i => !string.IsNullOrEmpty((i as Enum).ToDescription())).Select(value => new SelectListItem
                {
